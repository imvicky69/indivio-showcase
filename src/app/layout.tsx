...
export const metadata: Metadata = {
	...
	icons: {
		icon: [
			{ url: '/indivio-16x16.png', sizes: '16x16' },
			{ url: '/indivio-32x32.png', sizes: '32x32' },
			{ url: '/indivio-48x48.png', sizes: '48x48' },
			{ url: '/indivio-64x64.png', sizes: '64x64' },
			{ url: '/indivio-192x192.png', sizes: '192x192' },
			{ url: '/indivio-512x512.png', sizes: '512x512' },
		],
		apple: [{ url: '/indivio-192x192.png', sizes: '180x180' }],
		shortcut: [{ url: '/indivio-32x32.png' }],
	},
